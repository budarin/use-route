...
- **Слой для чистой архитектуры и динамических маршрутов** — роутинг отвечает только за URL и историю, а дерево экранов, загрузка данных, guards и редиректы живут в приложении (use cases, сервисы).
